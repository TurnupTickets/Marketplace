...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "icon", href: "/fav/favicon.ico", type: "image/x-icon" },
      { rel: "icon", href: "/fav/favicon-32x32.png", type: "image/png", sizes: "32x32" },
      { rel: "icon", href: "/fav/favicon-16x16.png", type: "image/png", sizes: "16x16" },
      { rel: "apple-touch-icon", href: "/fav/apple-touch-icon.png", sizes: "180x180" },
